...
Category.create(name: "Uncategorized", description: "Uncategorized shows")
...
Categorization.create(video_id: 1, category_id: 4)
Categorization.create(video_id: 2, category_id: 2)
Categorization.create(video_id: 2, category_id: 3)
